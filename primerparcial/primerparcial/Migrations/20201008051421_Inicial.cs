        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Fecha = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2020, 10, 8, 5, 14, 20, 390, DateTimeKind.Utc).AddTicks(3452)),
                    Tiempo = table.Column<string>(maxLength: 30, nullable: false),
